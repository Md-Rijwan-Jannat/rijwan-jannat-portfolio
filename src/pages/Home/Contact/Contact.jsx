    ...
    return (
        <div className="my-16 m-5">
            ...
            <h2 className='text-2xl font-semibold text-gray-500 text-center px-5 border-b-2 pb-2 border-gray-600 '>Send Your Mail</h2>
                <form ref={form} onSubmit={sendEmail} className="w-full p-10 lg:w-1/2 rounded-md">
                    <div className="flex flex-col gap-5 w-full">
                        <div className="w-full mb-4">
                            <h4 className="text-xl text-gray-500 uppercase mb-2">Your Name *</h4>
                            <input className="px-2 w-full rounded-md aria-selected:border-2 bg-blue-100 bg-opacity-10 text-gray-500 py-4 border-blue-800" name="name" type="text" placeholder="Enter You Name" />
                        </div>
                        <div className="w-full mb-4">
                            <h4 className="text-xl text-gray-500 uppercase mb-2">Your Email *</h4>
                            <input className="px-2 w-full rounded-md aria-selected:border-2 bg-blue-100 bg-opacity-10 text-gray-500 py-4 border-blue-800" name="email" type="email" placeholder="Enter You email" />
                        </div>
                        <div className="w-full mb-4">
                            <h4 className="text-xl text-gray-500 uppercase mb-2">Your Message *</h4>
                            <textarea className="px-2 w-full rounded-md aria-selected:border-2 bg-blue-100 bg-opacity-10 text-gray-500 py-4 border-blue-800" name="message" type="text" placeholder="Text Message" rows={5} />
                        </div>
                        ...
                        >
                            <input className="py-4 rounded-xl font-bold uppercase" type="submit" />
                        </motion.div>
                    </div>
                </form>
