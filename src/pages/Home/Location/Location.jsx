    ...
    return (
        <div className="mb-10">
            ...
            <Helmet>
                ...
                <div data-aos="flip-down" className="flex flex-col items-center space-y-5 bg-[#161042] shadow-lg px-5 py-10 mx-5 md:mx-0 lg:p-16 rounded-2xl">
                    ...
                    <div className='md:flex w-full gap-10'>
                        ...
                        <div className='w-full'>
                            <div className='mb-5'>
                            <h2 className='text-4xl text-gray-500 mt-5 mb-1'>Location</h2>
