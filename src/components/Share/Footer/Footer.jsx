                ...
                <div className='flex  flex-col mb-5'>
                    ...
                    <div className="avatar online">
                        <div className="w-16  relative rounded-full">
                            <img className='absolute bgw md:mb-10' src={rijwan_1} />
                        </div>
                    </div>
                ...
                <div className='flex  flex-col mb-5'>
                    ...
                    <div className="form-control w-80">
                        ...
                        <div className="relative flex flex-col">
                            ...
                            <button className="btn bg-blue-700 bg-opacity-20 hover:bg-[#150c55] border-gray-500 text-slate-300 absolute top-0 right-0 rounded-l-none">Subscribe</button>
                        </div>
                    </div>
                </div>
            </footer>
