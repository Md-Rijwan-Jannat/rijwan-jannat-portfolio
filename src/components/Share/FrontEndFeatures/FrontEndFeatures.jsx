...
const FrontEndFeatures = ({ image, title }) => {
    return (
        <div className="mx-5 p-5">
            <div className="flex flex-col items-center justify-center bg-[#231769] bg-opacity-50 py-10 shadow shadow-blue-400 hover:shadow-md hover:shadow-blue-500 text-gray-600 p-3 rounded-lg ">
